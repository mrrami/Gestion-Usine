...
namespace GestionUsine.Controllers
{
    public class SuperUsersController : Controller
    {
        ...
        public SuperUsersController(GestionUsineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Email,MotDePasse")] SuperUser superUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Email,MotDePasse")] SuperUser superUser)
        {
            if (id != superUser.Id)
            {
                return NotFound();
